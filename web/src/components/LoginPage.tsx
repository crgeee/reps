...
const RepsIcon = () => (
  <svg className="w-10 h-10 inline-block mr-2 align-middle" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col">
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-sm p-8 text-center">
            <h1 className="text-4xl font-bold tracking-tight mb-2"><RepsIcon />reps</h1>
