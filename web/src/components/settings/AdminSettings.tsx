  ...
  return (
    <div className="space-y-5">
      ...
      <button
        ...
        className="w-full flex items-center gap-3 px-4 py-3 bg-zinc-900/50 border border-zinc-800 rounded-xl text-left hover:bg-zinc-800/50 transition-colors group"
      >
        <svg
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-zinc-200">Server Logs</p>
          <p className="text-xs text-zinc-500 mt-0.5">
            View request logs, errors, and latency metrics
          </p>
        </div>
        <svg
